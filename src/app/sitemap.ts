...
const toolSlugMap: Record<string, Record<string, string>> = {
  ...
  'teste-velocidade-internet': { en: 'internet-speed-test', pt: 'teste-velocidade-internet', es: 'prueba-velocidade-internet' },
  'mesclar-pdf': { en: 'merge-pdf', pt: 'mesclar-pdf', es: 'fusionar-pdf' },
  'dividir-pdf': { en: 'split-pdf', pt: 'dividir-pdf', es: 'dividir-pdf' },
  'girar-pdf': { en: 'rotate-pdf', pt: 'girar-pdf', es: 'rotar-pdf' },
  'calculadora-imc': { en: 'bmi-calculator', pt: 'calculadora-imc', es: 'calculadora-imc' },
  'calculadora-idade': { en: 'age-calculator', pt: 'calculadora-idade', es: 'calculadora-edad' },
  'conversor-case': { en: 'case-converter', pt: 'conversor-case', es: 'conversor-mayusculas' },
  ...
  'conversor-fuso-horario': { en: 'timezone-converter', pt: 'conversor-fuso-horario', es: 'conversor-zona-horaria' },
  'comparador-texto': { en: 'text-comparator', pt: 'comparador-texto', es: 'comparador-texto' },
  'conversor-unidades': { en: 'unit-converter', pt: 'conversor-unidades', es: 'conversor-unidades' },
